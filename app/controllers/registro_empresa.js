...
$(function () {
    const urlBase = '../models/registrar_empresa.php'; // Ruta a tu archivo PHP único
     ...
     * @param {string} paisId - El ID del país seleccionado.
     */
     ...
     * @param {string} municipioId - El ID del municipio seleccionado.
     */
    ...
    $("#registroEmpresaForm").on("submit", function (e) {
        ...
        .fail(function (jqXHR, textStatus, errorThrown) {
            ...
            Swal.fire({
                title: 'Error',
                text: 'No se pudo conectar con el servidor o hubo un error en la respuesta.',
                icon: 'error'
            });
        });
    });
